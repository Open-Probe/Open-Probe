...
class OpenDeepSearchAgentLanggraph:
    def __init__(
        self,
        ...
        self.model = model if model is not None else os.getenv("LITELLM_SEARCH_MODEL_ID", os.getenv("LITELLM_MODEL_ID", "google/gemini-2.0-flash-001"))
    ...
    async def ask(
        ...
        client = OpenAI(
            ...
            api_key="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",
        )
